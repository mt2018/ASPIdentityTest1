...
using ASPIdentityTest1.Services;
using ASPIdentityTest1.Data;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //model.SecurityQuestion1 = question.GetQuestions();
                //
                if (result.Succeeded)
                {
        ...
        private IEnumerable<SelectListItem> GetQuestions()
        {
            ...
            var questions = SecurityQuestions
                        .GetQuestions()
                        .Select(x =>
                                new SelectListItem
                                {
                                    Value = x.SelectedQuestionId.ToString(),
                                    Text = x.Question
                                });
